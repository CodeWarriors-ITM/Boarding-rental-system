...
const PrivacyPolicyPage = () => {
    return (
        <ContainerFluid className={"bg-b-bg py-8"}>
            <Container>
                <div className="text-justify bg-white shadow p-4 rounded">
                    <h2 className={"text-3xl"} style={{textAlign: 'center'}}><b>PRIVACY POLICY</b></h2>
                    <p>Effective date: 2026-02-11</p>
                    <p className={"mt-4 text-xl"}>1. <b>Introduction</b></p>
                    <p>Welcome to <b> Bodima.lk</b>.</p>
                    <p><b>Bodima.lk</b> (“us”, “we”, or “our”) operates <b>Bodima.lk</b> (hereinafter referred to
                        as <b>“Service”</b>).</p>
                    <p>Our Privacy Policy governs your visit to <b>Bodima.lk</b>, and explains how we collect, safeguard and
                    ...
                    <p className={"mt-4 text-xl"}>2. <b>Definitions</b></p>
                    <p><b>SERVICE</b> means the Bodima.lk website operated by Bodima.lk.</p>
                    ...
                    <p><b>DATA PROCESSORS (OR SERVICE PROVIDERS)</b> means any natural or legal person who processes the
                        ...
                        process
                        your data more effectively.</p> <p><b>DATA SUBJECT</b> is any living individual who is the subject
                    of
                    Personal Data.</p>
                    ...
                    <p className={"mt-4 text-xl"}>3. <b>Information Collection and Use</b></p>
                    <p>We collect several different types of information for various purposes to provide and improve our
                        Service
                        to you.</p>
                    <p className={"mt-4 text-xl"}>4. <b>Types of Data Collected</b></p>
                    ...
                    <p>When you access Service with a device, this Usage Data may include information such as the type of
                        device
                        you use, your device unique ID, the IP address of your device, your device operating system, the
                        type of
                    ...
                    permission
                    to do so (<b>“Location Data”</b>). We use this data to provide features of our Service, to improve and
                    customize our Service.</p><p>You can enable or disable location services when you use our Service at any
                    ...
                    <p>Cookies are files with a small amount of data which may include an anonymous unique identifier.
                        Cookies
                        are sent to your browser from a website and stored on your device. Other tracking technologies are
                        also
                    ...
                    <p>While using our Service, we may also collect the following information: sex, age, date of birth,
                        place of
                        birth, passport details, citizenship, registration at place of residence and actual address,
                        telephone
                    ...
                    <p className={"mt-4 text-xl"}>5. <b>Use of Data</b></p>
                    <p>Bodima.lk uses the collected data for various purposes:</p>
                    ...
                    <p className={"mt-4 text-xl"}>6. <b>Retention of Data</b></p>
                    ...
                    <p className={"mt-4 text-xl"}>7. <b>Transfer of Data</b></p>
                    ...
                    <p>Bodima.lk will take all the steps reasonably necessary to ensure that your data is treated securely
                        and
                    ...
                    <p className={"mt-4 text-xl"}>8. <b>Disclosure of Data</b></p>
                    <p>We may disclose personal information that we collect, or you provide:</p>
                    <p>0.1. <b>Disclosure for Law Enforcement.</b></p><p>Under certain circumstances, we may be required to
                    disclose your Personal Data if required to do so by law or in response to valid requests by public
                    authorities.</p><p>0.2. <b>Business Transaction.</b></p><p>If we or our subsidiaries are involved in a
                    merger, acquisition or asset sale, your Personal Data may be transferred.</p><p>0.3. <b>Other cases. We
                    may
                    disclose your information also:</b></p><p>0.3.1. to our subsidiaries and affiliates;</p><p>0.3.2. to
                    contractors, service providers, and other third parties we use to support our business;</p><p>0.3.3. to
                    fulfill the purpose for which you provide it;</p><p>0.3.4. for the purpose of including your company’s
                    logo
                    on our website;</p><p>0.3.5. for any other purpose disclosed by us when you provide the information;</p>
                    <p>0.3.6. with your consent in any other cases;</p><p>0.3.7. if we believe disclosure is necessary or
                    appropriate to protect the rights, property, or safety of the Company, our customers, or others.</p>
                    <p className={"mt-4 text-xl"}>9. <b>Security of Data</b></p>
                    ...
                    <p className={"mt-4 text-xl"}>10. <b>Your Data Protection Rights Under General Data Protection
                        Regulation (GDPR)
                    </b></p>
                    ...
                    <p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed
                        from
                        our systems, please email us at <b>info@bodima.lk</b>.</p>
                    ...
                    <p>You have the right to complain to a Data Protection Authority about our collection and use of your
                        ...
                        European
                        Economic Area (EEA).</p>
                    <p className={"mt-4 text-xl"}>11. <b>Your Data Protection Rights under the California Privacy Protection
                        Act (CalOPPA)</b></p>
                    ...
                    <p>0.4. users are able to change their personal information by emailing us at <b>info@bodima.lk</b>.</p>
                    ...
                    <p>You can enable or disable Do Not Track by visiting the Preferences or Settings page of your web
                        browser.</p>
                    <p className={"mt-4 text-xl"}>12. <b>Your Data Protection Rights under the California Consumer Privacy
                        Act (CCPA)</b></p>
                    ...
                    <p><b>0.3. To stop selling your personal information. We don’t sell or rent your personal information to
                        ...
                        our
                        family of companies, without monetary consideration may be considered a “sale” under California law.
                        You
                    ...
                    <p>Please note, if you ask us to delete or stop selling your data, it may impact your experience with
                        ...
                        usage of your personal information to function. But in no circumstances, we will discriminate
                        against
                    ...
                    <p>To exercise your California data protection rights described above, please send your request(s) by
                        email: <b>info@bodima.lk</b>.</p>
                    <p>Your data protection rights, described above, are covered by the CCPA, short for the California
                        Consumer
                        Privacy Act. To find out more, visit the official California Legislative Information website. The
                        CCPA
                        took effect on 01/01/2020.</p>
                    <p className={"mt-4 text-xl"}>13. <b>Service Providers</b></p>
                    ...
                    <p className={"mt-4 text-xl"}>14. <b>Analytics</b></p>
                    <p>We may use third-party Service Providers to monitor and analyze the use of our Service.</p>
                    <p className={"mt-4 text-xl"}>15. <b>CI/CD tools</b></p>
                    <p>We may use third-party Service Providers to automate the development process of our Service.</p>
                    <p className={"mt-4 text-xl"}>16. <b>Advertising</b></p><p>We may use third-party Service Providers to
                    show advertisements to you to
                    help support and maintain our Service.</p>
                    <p className={"mt-4 text-xl"}>17. <b>Behavioral Remarketing</b></p>
                    ...
                    <p className={"mt-4 text-xl"}>18. <b>Payments</b></p><p>We may provide paid products and/or services
                    within Service. In that case, we
                    use third-party services for payment processing (e.g. payment processors).</p><p>We will not store or
                    collect your payment card details. That information is provided directly to our third-party payment
                    ...
                    <p className={"mt-4 text-xl"}>19. <b>Links to Other Sites</b></p>
                    ...
                    <p className={"mt-4 text-xl"}>20. <b><b>Children’s Privacy</b></b></p>
                    ...
                    <p className={"mt-4 text-xl"}>21. <b>Changes to This Privacy Policy</b></p>
